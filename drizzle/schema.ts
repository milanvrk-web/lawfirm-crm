...
export const leads = mysqlTable("leads", {
  ...
  alienNumber: varchar("alienNumber", { length: 50 }).default("").notNull(),
  dateOfBirth: varchar("dateOfBirth", { length: 10 }).default("").notNull(),
  address: text("address").notNull(),
  preferredLanguage: varchar("preferredLanguage", { length: 100 }).default("").notNull(),
